...
Đọc [hướng dẫn bắt đầu cho Visual Novel](vn.md) để bắt đầu.
...
- Cài đặt Yomitan [đọc ở đây](yomichan.md)  
- Itazuraneko in [Resources](resources.md)  
...
### Yomitan, Mokuro, và một phần mềm OCR đủ tốt
...
### Sự hữu ích của việc học ngữ pháp và một số từ điển Yomitan hỗ trợ điều này.
...
Giờ thì, một số từ điển Yomitan mà bạn nên dùng là:
...
Yomitan khiến mọi thứ trở nên thật dễ dàng.
...
Nhưng BẠN đang sống vào thời đại công nghệ. BẠN có Yomitan. Hãy tận dụng nó.
